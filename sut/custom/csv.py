...
import re
import types
from _csv_custom import Error, __version__, writer, reader, register_dialect, \
                 unregister_dialect, get_dialect, list_dialects, \
                 field_size_limit, \
                 QUOTE_MINIMAL, QUOTE_ALL, QUOTE_NONNUMERIC, QUOTE_NONE, \
                 QUOTE_STRINGS, QUOTE_NOTNULL, \
                 __doc__
from _csv_custom import Dialect as _Dialect
...
class ValidationReader:
    """Wraps csv.reader to collect malformed rows instead of raising.
    ...
    def __next__(self):
        while True:
            row = next(self._reader)  # raises StopIteration naturally
            n = self._expected
